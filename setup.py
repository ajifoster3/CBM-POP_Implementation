...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'realistic_fitness_logger = cbm_pop.RealisticSimulator.realistic_fitness_logger:main',
            ...
            'cbm_population_agent_online_simple_simulation_offline_UCB = cbm_pop.SimpleSimulator.cbm_population_agent_online_simple_simulation_offline_UCB:main',
            'des_sim = cbm_pop.DESSimulator.run_des_sim:main',
            'greedy_agent_online_simple_simulation = cbm_pop.SimpleSimulator.greedy_agent_online_simple_simulation:main',
            ...
            'cbm_population_agent_online_realistic_simulation = cbm_pop.RealisticSimulator.cbm_population_agent_online_realistic_simulation:main',
            'greedy_agent_online_realistic_simulation = cbm_pop.RealisticSimulator.greedy_agent_online_realistic_simulation:main',
            'realistic_simulator = cbm_pop.RealisticSimulator.realistic_simulator:main',
            'realistic_robot = cbm_pop.RealisticSimulator.realistic_robot:main',
