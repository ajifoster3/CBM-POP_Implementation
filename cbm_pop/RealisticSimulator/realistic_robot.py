...
class RealisticRobot(Node):
    ...
    def __init__(self,
        ...
        self.global_pose_publisher = self.create_publisher(
            GeoPoseStamped, f'/central_control/uas_{self.robot_id}/global_pose', 10
        )
        self.goal_pose_subscriber = self.create_subscription(
            GeoPoseStamped, f'/central_control/uas_{self.robot_id}/goal_pose',
