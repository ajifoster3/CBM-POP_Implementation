...
from cbm_pop.RealisticSimulator.realistic_robot import RealisticRobot as robot
...
def main():
    ...
    problem = RealisticProblem(problem_class=ProblemClass(problem_class), grid_size=problem_size, problem_seed=problem_seed)
    ...
    simulator = RealisticSimulator(tasks, env_bounds, starts, obstacles=1, args=args)
